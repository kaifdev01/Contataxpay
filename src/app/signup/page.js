          ...
          <div className="hidden md:flex w-1/2 flex-col items-center justify-end gap-[40%] p-8 z-40">
            <div>
              ...
              <p className="text-[#4B5563] text-[18px] w-[403px]">
                ...
                to run your business, in one sign up.
              </p>
            </div>
          ...
          <div className="w-full md:w-1/2 p-4 md:p-8 z-40 flex justify-center">
            ...
            >
              ...
              <div className="flex gap-4 mb-6">
                <button className="bg-[#0077B6] h-[40px] w-full text-white rounded-[14px]">
                  Client
                </button>
                <button
                  className="bg-white h-[40px] w-full text-[#0077B6]
              ...
              <form className="flex flex-col gap-4">
                {["Name", "Email or phone", "Country", "Password"].map(
                  (label) => (
                    <div
                      key={label}
